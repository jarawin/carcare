...
function NatInput() {
    return (
        <div className="">
            ...
            <label for="input-License plate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your License Plate</label>
            <div class="relative mb-6">
                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
            ...
            <label for="input-promotion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Promotion</label>
            <div class="relative mb-6">
                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
