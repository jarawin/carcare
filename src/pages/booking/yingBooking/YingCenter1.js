        ...
        <div name="CenterBox" className="">
          <div className="container px-4 mx-auto max-w-5xl">
            <div className="text-center py-14">
              <h1 className=" font-itim  text-7xl font-bold font-title text-sec text-red-700">
                Car Washing
                <br />
                <span className=" text-black text-6xl font-itim ">
                  Online Booking Service
                </span>
              </h1>
              <p className=" text-xl max-w-sm mx-auto py-6">
