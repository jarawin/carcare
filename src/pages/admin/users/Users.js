...
function Users() {
  ...
  return (
    <div className="overflow-x-auto relative  ">
      <div className="flex justify-between items-center pb-4 bg-white dark:bg-gray-900 pt-5">
        <div className="pl-4">
          <button
            ...
            type="button"
            onClick={() => setIsActionShow(!isActionShow)}
          >
          ...
          <div
            ...
            // style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transhtmlForm: translate3d(0px, 46px, 0px);"
            style={{
              position: 'absolute',
              inset: 0,
              margin: 0,
